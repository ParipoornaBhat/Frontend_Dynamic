...
const NavBar = () => {
  ...
  return (
    ...
    <div className="nav-con">
      <nav className={`navbar ${isNavbarVisible ? "" : "navbar-hidden"}`} id="navbar">
        <Link to="/">
        ...
        <div className="navbar-hamburger" onClick={toggleNav} id="hamburger">
          ...
          {token ? (
            ...
            Profile
              ...
              {employeeRoles.some(r => r.roleName === role) && (
                <>
                  {/* Check if either GetAllEmployees or GetAllUsers is in actions and canView is true */}
